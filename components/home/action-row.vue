<template>
  <div class="info-row action-row">
    <ul class="action-list">
      <li class="item like clickable" @click.stop.prevent="handleLike">
        <p class="title-box">
          <img src="~/assets/img/like.svg">
          <span class="count">{{ item.collectionCount }}</span>
        </p>
      </li>
      <li class="item comment clickable" @click.stop.prevent="handleComment">
        <p class="title-box">
          <img src="~/assets/img/comment.svg">
          <span class="count">{{ item.commentsCount }}</span>
        </p>
      </li>
      <li class="item share clickable hover" title="分享" @click.stop.prevent="handleShare">
        <p class="title-box">
          <img src="~/assets/img/share.svg">
        </p>
      </li>
      <li class="item collect clickable hover" title="收藏" @click.stop.prevent="handleCollect">
        <p class="title-box">
